...
**I want** the system to maintain a rolling buffer of 15-minute OHLCV candles for all 29 pairs,  
...
#### Story S3.2.1
**As an** LLM,  
**I want** to receive a compact, normalised summary of all 29 pairs in a single prompt,  
**so that** I can rank opportunities and make decisions without exceeding token limits.

**Acceptance Criteria:**
- [ ] AC1: `build_cycle_prompt()` produces a prompt under 2,000 tokens for all 29 pairs.  
