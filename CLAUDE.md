...
- **Per-pair buy_min_score (#128)**: `signals.py` reads `pair_cfg.get("buy_min_score", global_min_score)`. INJ=7, SOL/UNI=6 (underperformers per 2026-04-09 backtest). ETH/BNB/DOGE=5 (explicit). Global default = 5.
