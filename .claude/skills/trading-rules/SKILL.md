...
- **BTC Dominance Macro Overlay (#206)**: Rising BTC dominance is a macro headwind for altcoins. When the regime context shows `btc_dominance_trend = rising`, prefer majors over speculative alts and avoid treating weak alt BUYs as normal dip-buy setups. If you change regime logic, prompt guidance, or sizing logic, preserve this macro overlay so capital rotation into BTC is reflected in altcoin risk appetite.
